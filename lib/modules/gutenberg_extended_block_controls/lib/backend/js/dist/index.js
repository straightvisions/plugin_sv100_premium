...
function $20b4a97a61b3fccb$export$cd46662790a9feff(selectors, blockId, isResponsive = false, screen = "", breakpoint_calc = "from", reverseSelector = false) {
    ...
    /* --------------------------------------------- */ for(let i in selectors){
        ...
        for(let j in sel){
            ...
            if (typeof sel[j] !== "undefined" && checkString) css += j + ": " + sel[j] + ";";
        }
        if (css !== "") {
...
function $603b00a8dca58242$var$FlexCoreColumns(props) {
    ...
    if (values[$603b00a8dca58242$var$_prefix + "Active"] === true && values.flexCoreColumnsInit === false) {
        ...
        attr.parsedCSS["StackFlex"] = (0, $c855a9a458ffcf3e$export$2e2bcd8739ae039)(attr, props.name); //collapse css objects
        let css = "";
        Object.keys(attr.parsedCSS).map(function(key, index) {
    ...
    }), /*#__PURE__*/ React.createElement((0, $7b93dac3912d9f2f$export$2e2bcd8739ae039), props), /*#__PURE__*/ React.createElement((0, $47170f8e9f9bcd6f$export$2e2bcd8739ae039), props), /*#__PURE__*/ React.createElement((0, $fc4f22f8a866e147$export$2e2bcd8739ae039), props));
